      ...
      <ReactElasticCarousel breakPoints={breakPoints} focusOnSelect={true}>
        ...
        >
          <Typography className="longText" style={textStyle}>
            ...
            development but also possesses a deep understanding of the intricate
            complexities within the IT landscape."
          </Typography>
        </RecommendationCard>
        <RecommendationCard
          image={chami}
        ...
        >
          <Typography className="longText" style={textStyle}>
            ...
            passionate about software development. Also, he is a hardworking and
            calm person."
          </Typography>
        </RecommendationCard>
